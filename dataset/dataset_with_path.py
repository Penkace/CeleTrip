...
#                 print('In degree : ',in_deg)
            ...
            name_features = torch.tensor([name_index_dict[person_name]])
            # print(name_features)
            ...
            self.name_features.append(name_features)
...
class Config:
    save_path = '/public/home/pengkai/Itinerary_Miner/CeleTrip/graph_data/path_oriented/'

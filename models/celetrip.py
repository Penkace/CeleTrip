...
class CeleTrip(nn.Module):
    def __init__(self,outputs,
        ...
        # self.sg_linear2 = nn.Linear(na_out+50,na_out)
...
#         self.event_sentence_layer = ScaledDotProductAttention(100,128,64)
    ...
    def forward(self,mgraph,subgraph_list,na_feature,event_feature,entity_features,event_freq_feature,entity_graph_list,entity_graph_features_list,location_embed_matrix,device='cuda'):
        ...
        for subg in subgraph_list:
            ...
            feats = F.relu(self.sg_linear(feats))
